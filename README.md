...
<img src="./assets/Logo/Logo.png" alt="Logo" width="100" height="100" /># Lothlorien-Ledger
...
* **Basic arithmetic:** `+`, `-`, `*`, `/`
* **Advanced operations:** `%`, `^` (exponentiation), unary minus
* **Decimal support:** intuitive handling of floating-point numbers
...
On Windows, you can open the project in Qt Creator and build/run directly.

---

## Usage

* Launch the application: `Lothlorien-Ledger`
